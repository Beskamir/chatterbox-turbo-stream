...
# from tqdm import tqdm # Debug Note: uncomment this for debug progress bar
...
class CausalConditionalCFM(ConditionalCFM):
    ...
    def basic_euler(self, x, t_span, mu, mask, spks, cond):
        ...
        # print("S3 Token -> Mel Inference...") # Uncomment this for debug print
        # Debug Note: wrap this in tqdm for fancy debug progress bar
